...
/**
 * char_find - function that  converts a char to a string
 * @c: char
 * Return: string
 */
...
/**
 * string_find - function that parses a string to print
 * @s: string
 * Return: "string"
 */
...
/**
 * percent_find - function that  parses a '%' sign
...
/**
 * int_find - function that converts integers to char arrays
...
/**
 * unsigned_find - function that converts unsigned int to char array
